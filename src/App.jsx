...
function App() {
	...
	const tabs = [
		{
			name: "버튼 탭1",
			tag: "button",
			content: "이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.이건 탭 내용이다.",
		},
		{
			name: "버튼 탭2",
			tag: "button",
	...
	const dropdowns = [
		...
		},
		{
			id: "dropdowm02",
			title: "item2",
			lists: [{ name: "item111", url: "#" }, { name: "item111", url: "#" }, { name: "item111", url: "#" }, { name: "item111", url: "#" }, { name: "item111" }, { name: "item11213233123123121item11213233123123121item11213233123123121item11213233123123121" }, { name: "item11231231211" }],
		},
	];
